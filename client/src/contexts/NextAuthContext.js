...
let users = [
  {
    id: '5e86809283e28b96d2d43531',
    email: 'hello@world.com',
    password: '123456',
    name: 'H' + process.env.JWT_SECRET
  }
];
// constant
const initialState = {
...
export const NextAuthProvider = ({ children }) => {
  ...
  return <NextAuthContext.Provider value={{ ...state, login, logout, register, resetPassword, updateProfile }}>{children}</NextAuthContext.Provider>;
};
